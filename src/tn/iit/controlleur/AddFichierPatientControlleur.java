...
/**
 * Servlet implementation class AddFichierPatientControlleur
 */
@WebServlet("/AddFichierPatientControlleur")
public class AddFichierPatientControlleur extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AddFichierPatientControlleur() {
        super();
    }
