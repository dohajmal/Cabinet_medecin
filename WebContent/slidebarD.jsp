			...
			<li class="dropdown dropdown-fuse"><a href="#"
				class="dropdown-toggle mln" data-toggle="dropdown"> <span
					...
					<span class="profile-online"> <img
						src="assets/img/avatars/docteur.jpg" alt="avatar">
				</span>
			</a>
		...
		<div class="sidebar-left-content nano-content">
			...
			<div class="sidebar-widget author-widget">
				<div class="media">
					<a class="media-left profile-online" href="#"> <img
						src="assets/img/avatars/docteur.jpg" class="img-responsive"
						alt="">
					</a>
			...
			<ul class="nav sidebar-menu">
				...
				<li><a class="accordion-toggle" href="#"> <span
					...
					<ul class="nav sub-nav">
						<li><a href="http://localhost:5050/Cabinet_medecin/ListeCertificatDeRepoControlleur">Lister Certificat Repos </a>
						</li>
						<li><a href="http://localhost:5050/Cabinet_medecin/AddCertificatDeReposControlleur">Ajouter Certificat Repos </a></li>
						<li><a href="#">Modifier Certificat Repos </a></li>
						<li><a href="#">Supprimer Certificat Repos </a></li>
				...
				<li><a class="accordion-toggle" href="#"> <span
					...
					<ul class="nav sub-nav">
						<li><a href="http://localhost:5050/Cabinet_medecin/ListeCertificatsmedicauxControlleur">Liste Certification Médicaux </a>
						</li>
				...
				<li><a class="accordion-toggle" href="#"> <span
					...
					<ul class="nav sub-nav">
						<li><a href="http://localhost:5050/Cabinet_medecin/ListeFichierPatientControlleur"> Liste Fichier du Patient </a>
						</li>
						<li><a href="http://localhost:5050/Cabinet_medecin/AddFichierPatientControlleur"> Ajouter Fichier du Patient </a></li>
						<li><a href="#"> Modifier Fichier du Patient </a></li>
						<li><a href="#"> Supprimer Fichier du Patient </a></li>
