...
<!-- Meta and Title -->
<meta charset="utf-8">
<title>myAdmin - A Responsive Bootstrap 3 Admin Dashboard
	Template</title>
<meta name="keywords"
		...
		<ul class="nav navbar-nav navbar-right">
			<li class="dropdown dropdown-fuse"><a href="#"
				class="dropdown-toggle mln" data-toggle="dropdown"> <span
					class="hidden-xs hidden-sm"><span class="name">Doha Jmal</span></span> <span class="fa fa-caret-down hidden-xs hidden-sm"></span>
					<span class="profile-online"> <img
						src="assets/img/avatars/doha.jpg" alt="avatar">
				</span>
			</a>
		...
		<div class="sidebar-left-content nano-content">
			...
			<div class="sidebar-widget author-widget">
				<div class="media">
					<a class="media-left profile-online" href="#"> <img
						src="assets/img/avatars/doha.jpg" class="img-responsive"
						alt="">
					</a>

					<div class="media-body">
						<div>Welcome</div>
						<div class="media-author">Doha Jmal</div>
					</div>
				</div>
			</div>
			...
			<!-- Sidebar Menu  -->
			  ...
			  <ul class="nav sidebar-menu">
                        <li><a class="accordion-toggle" href="#"> <span class="sidebar-title">Secretaire</span> <span class="caret"></span>
                         <span class="sb-menu-icon fa fa-calendar"></span>
                </a>
                    <ul class="nav sub-nav">
                        <li><a href="#">Lister Secretaire </a>
                        </li>
                        <li><a href="#"> Ajouter Secretaire</a></li>
                        <li><a href="#"> Modifier Secretaire </a></li>
                        <li><a href="#"> Supprimer Secretaire</a></li>

                    </ul></li>
                
                
                
                <li><a class="accordion-toggle" href="#"> <span class="sidebar-title">Medecin</span> <span class="caret"></span> <span class="sb-menu-icon fa fa-list-ul"></span>
                </a>
                    <ul class="nav sub-nav">
                        <li><a href="#"> Lister Medecin</a>
                        </li>
                        <li><a href="#"> Ajouter Medecin</a></li>
                        <li><a href="#"> Modifier Medecin</a></li>
                        <li><a href="#"> Supprimer Medecin </a></li>
