...
<!-- menu3 -->
  ...
  ">
	...
	<div class="chute chute-center">
		...
		<div class="row">
			<div class="col-xs-12" style="width: 82%;">
				<div class="panel">
					<div class="panel-heading">
						<span class="panel-title hidden-xs" style="color:#10cfbd;">Add Fichier Patient</span>
					</div>
	...
	<label>Sex :</label><div class="radio" class="form-control">
	<input id="male" type="radio" name="sex" value="homme"> 
	<label for="male" style="color: #000;font-family: cursive;">Homme</label> 
	<input id="female" type="radio" name="sex" value="female"> <label for="female" style="color: #000;font-family: cursive;">Femme</label>
	</div>
	<label>	nationnalite: </label><input name="nationnalite" type="text" class="form-control" placeholder="Nationnalite" required /><br />
	<label>	Date De Rendez-vous :</label> <input name="daterendezvous" type="text" class="form-control" placeholder="DD-MM-YYYY" required /><br />
	...
	<option value="1" selected>Selected id Patient</option>
	<d:forEach items="${patdao}" var="Patdao">
	<OPTION value="${Patdao.id}">${Patdao.id}</OPTION>
	</d:forEach>
	</SELECT> <br /> 
	<button name="inscription" type="submit" class="btn btn-primary mb5" />  <i class="fa fa-floppy-o pr5"></i> Add Fichier Patient</button>
